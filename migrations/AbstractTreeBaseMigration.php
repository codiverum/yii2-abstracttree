...
abstract class AbstractTreeBaseMigration extends Migration {
    ...
    protected function addIndexesAndKeys() {
        ...
        $this->addForeignKey('fk_' . $nodeAncestorKeyName . '_' . $nodeKeyName, $nodeAncestorName, 'id', $nodeName, 'id', 'CASCADE', 'CASCADE');
        $this->addForeignKey('fk_' . $nodeAncestorKeyName . '_ancestor', $nodeAncestorName, 'id_ancestor_' . $nodeName, 'id', 'CASCADE', 'CASCADE');
    }
